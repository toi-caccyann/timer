// 1. 画面の部品（HTML要素）をJavaScriptに連れてくる
        ...
        startBtn.addEventListener('click', () => {
            ...
            // 💡新武器：1000ミリ秒（1秒）ごとに、中の処理をずっと繰り返す（予約券を発行）
            timerId = setInterval(() => {
                // ① 裏の秒数を1増やす
                seconds++;
        ...
        stopBtn.addEventListener('click', () => {
            ...
            if (timerId !== null) {
                ...
                // タイマーが止まったので、財布（変数）を空っぽ（null）に戻す
                timerId = null;
            }
        });
        

        // 5. 【大幅変更】ボタンの代わりに、GPS（位置情報）の変化をリアルタイムに監視する
